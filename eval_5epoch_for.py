...
parser.add_argument('--trained_model',
                    # default=r"F:\pycharm_codes\ssdpytorch\ModelsVOC.pth", type=str,
                    default=r".\trainedModel\ModelsVOC.pth", type=str,
                    help='Trained state_dict file path to open')
parser.add_argument(  # '--save_folder', default='/media/dsg3/husheng/eval/', type=str,
    '--save_folder',
    # default=r"F:\pycharm_codes\ssdpytorch\test", type=str,
    default=r".\evalOuts\test", type=str,
...
parser.add_argument('--imagesetfile',
                    ...
                    default=r"F:\pycharm_codes\ssdpytorch\VOC2007\VOC2007\ImageSets\Main\test.txt", type=str,
...
# annopath = os.path.join(args.SIXray_root, r'VOC2007\Annotations', '%s.xml')
annopath = os.path.join(args.SIXray_root, r'VOC2007\Annotations', '%s.xml')

# imgpath = os.path.join(args.SIXray_root, 'cut_Image_core_coreless_battery_sub_2000_500', '%s.jpg')
imgpath = os.path.join(args.SIXray_root, r'VOC2007\JPEGImages', '%s.jpg')
...
def parse_rec(filename, imgpath):
    ...
    filename = filename.replace(r'F:\pycharm_codes\ssdpytorch\VOC2007\VOC2007\Annotations',
                                r'F:\pycharm_codes\ssdpytorch\all_samples\Annotation')
...
def reset_args(EPOCH):
    ...
    args.trained_model = r"F:\pycharm_codes\ssdpytorch\Models\ssd300_VOC_20000.pth".format(
        EPOCH)
    # saver_root = '/media/trs2/wuzhangjie/SSD/eval/Xray20190723/Attention/base_battery_core_coreless_bs8_V/'
    # saver_root = r'F:\pycharm_codes\ssdpytorch\eval_model'
    saver_root = r'.\evalOuts\eval_model'
